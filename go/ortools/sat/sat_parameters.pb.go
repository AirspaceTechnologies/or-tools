...
const (
	...
	SatParameters_BINARY_MINIMIZATION_FROM_UIP               SatParameters_BinaryMinizationAlgorithm = 1
	SatParameters_BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS SatParameters_BinaryMinizationAlgorithm = 5
)
...
var (
	SatParameters_BinaryMinizationAlgorithm_name = map[int32]string{
		...
		1: "BINARY_MINIMIZATION_FROM_UIP",
		5: "BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS",
	}
...
type SatParameters struct {
	...
	BinaryMinimizationAlgorithm        *SatParameters_BinaryMinizationAlgorithm     `protobuf:"varint,34,opt,name=binary_minimization_algorithm,json=binaryMinimizationAlgorithm,enum=operations_research.sat.SatParameters_BinaryMinizationAlgorithm,def=5" json:"binary_minimization_algorithm,omitempty"`
	...
	ExtraSubsumptionDuringConflictAnalysis *bool `protobuf:"varint,351,opt,name=extra_subsumption_during_conflict_analysis,json=extraSubsumptionDuringConflictAnalysis,def=1" json:"extra_subsumption_during_conflict_analysis,omitempty"`
	// Try even more subsumption options during conflict analysis.
	DecisionSubsumptionDuringConflictAnalysis *bool `protobuf:"varint,353,opt,name=decision_subsumption_during_conflict_analysis,json=decisionSubsumptionDuringConflictAnalysis,def=1" json:"decision_subsumption_during_conflict_analysis,omitempty"`
	// If >=0, each time we have a conflict, we try to subsume the last n learned
	// clause with it.
	EagerlySubsumeLastNConflicts *int32 `protobuf:"varint,343,opt,name=eagerly_subsume_last_n_conflicts,json=eagerlySubsumeLastNConflicts,def=4" json:"eagerly_subsume_last_n_conflicts,omitempty"`
	...
	SubsumeDuringVivification *bool `protobuf:"varint,355,opt,name=subsume_during_vivification,json=subsumeDuringVivification,def=1" json:"subsume_during_vivification,omitempty"`
	...
	UseChronologicalBacktracking *bool `protobuf:"varint,330,opt,name=use_chronological_backtracking,json=useChronologicalBacktracking,def=0" json:"use_chronological_backtracking,omitempty"`
	...
	MaxBackjumpLevels *int32 `protobuf:"varint,331,opt,name=max_backjump_levels,json=maxBackjumpLevels,def=50" json:"max_backjump_levels,omitempty"`
	// If chronological backtracking is enabled, this is the minimum number of
	// conflicts before we will consider backjumping.
	ChronologicalBacktrackMinConflicts *int32 `protobuf:"varint,332,opt,name=chronological_backtrack_min_conflicts,json=chronologicalBacktrackMinConflicts,def=1000" json:"chronological_backtrack_min_conflicts,omitempty"`
	...
	ClauseCleanupPeriodIncrement *int32 `protobuf:"varint,337,opt,name=clause_cleanup_period_increment,json=clauseCleanupPeriodIncrement,def=0" json:"clause_cleanup_period_increment,omitempty"`
	...
	ClauseCleanupLbdTier1 *int32 `protobuf:"varint,349,opt,name=clause_cleanup_lbd_tier1,json=clauseCleanupLbdTier1,def=0" json:"clause_cleanup_lbd_tier1,omitempty"`
	...
	ClauseCleanupLbdTier2 *int32                        `protobuf:"varint,350,opt,name=clause_cleanup_lbd_tier2,json=clauseCleanupLbdTier2,def=0" json:"clause_cleanup_lbd_tier2,omitempty"`
	...
	FilterSatPostsolveClauses *bool `protobuf:"varint,324,opt,name=filter_sat_postsolve_clauses,json=filterSatPostsolveClauses,def=0" json:"filter_sat_postsolve_clauses,omitempty"`
	...
	// to true.
	LoadAtMostOnesInSatPresolve *bool `protobuf:"varint,335,opt,name=load_at_most_ones_in_sat_presolve,json=loadAtMostOnesInSatPresolve,def=0" json:"load_at_most_ones_in_sat_presolve,omitempty"`
	...
	MaxAlldiffDomainSize *int32 `protobuf:"varint,320,opt,name=max_alldiff_domain_size,json=maxAlldiffDomainSize,def=256" json:"max_alldiff_domain_size,omitempty"`
	...
	MaxDomainSizeForLinear2Expansion *int32 `protobuf:"varint,340,opt,name=max_domain_size_for_linear2_expansion,json=maxDomainSizeForLinear2Expansion,def=8" json:"max_domain_size_for_linear2_expansion,omitempty"`
	...
	FindClausesThatAreExactlyOne *bool `protobuf:"varint,333,opt,name=find_clauses_that_are_exactly_one,json=findClausesThatAreExactlyOne,def=1" json:"find_clauses_that_are_exactly_one,omitempty"`
	...
	InprocessingUseCongruenceClosure *bool `protobuf:"varint,342,opt,name=inprocessing_use_congruence_closure,json=inprocessingUseCongruenceClosure,def=1" json:"inprocessing_use_congruence_closure,omitempty"`
	...
	// 2025.
	InprocessingUseSatSweeping *bool `protobuf:"varint,354,opt,name=inprocessing_use_sat_sweeping,json=inprocessingUseSatSweeping,def=0" json:"inprocessing_use_sat_sweeping,omitempty"`
	...
	ShareLinear2Bounds *bool `protobuf:"varint,326,opt,name=share_linear2_bounds,json=shareLinear2Bounds,def=0" json:"share_linear2_bounds,omitempty"`
	...
	ShareGlueClauses *bool `protobuf:"varint,285,opt,name=share_glue_clauses,json=shareGlueClauses,def=1" json:"share_glue_clauses,omitempty"`
	...
	ShareGlueClausesDtime *float64 `protobuf:"fixed64,322,opt,name=share_glue_clauses_dtime,json=shareGlueClausesDtime,def=1" json:"share_glue_clauses_dtime,omitempty"`
	...
	//   - symmetry_level <= 1.
	CheckLratProof *bool `protobuf:"varint,344,opt,name=check_lrat_proof,json=checkLratProof,def=0" json:"check_lrat_proof,omitempty"`
	...
	CheckMergedLratProof *bool `protobuf:"varint,352,opt,name=check_merged_lrat_proof,json=checkMergedLratProof,def=0" json:"check_merged_lrat_proof,omitempty"`
	...
	//   - linearization_level <= 1,
	//   - symmetry_level <= 1.
	OutputLratProof *bool `protobuf:"varint,345,opt,name=output_lrat_proof,json=outputLratProof,def=0" json:"output_lrat_proof,omitempty"`
	...
	//   - linearization_level <= 1,
	//   - symmetry_level <= 1.
	CheckDratProof *bool `protobuf:"varint,346,opt,name=check_drat_proof,json=checkDratProof,def=0" json:"check_drat_proof,omitempty"`
	...
	//   - linearization_level <= 1,
	//   - symmetry_level <= 1.
	OutputDratProof *bool `protobuf:"varint,347,opt,name=output_drat_proof,json=outputDratProof,def=0" json:"output_drat_proof,omitempty"`
	...
	MaxDratTimeInSeconds *float64 `protobuf:"fixed64,348,opt,name=max_drat_time_in_seconds,json=maxDratTimeInSeconds,def=inf" json:"max_drat_time_in_seconds,omitempty"`
	...
	DebugCrashIfLratCheckFails *bool `protobuf:"varint,339,opt,name=debug_crash_if_lrat_check_fails,json=debugCrashIfLratCheckFails,def=0" json:"debug_crash_if_lrat_check_fails,omitempty"`
	...
	TransitivePrecedencesWorkLimit *int32 `protobuf:"varint,327,opt,name=transitive_precedences_work_limit,json=transitivePrecedencesWorkLimit,def=1000000" json:"transitive_precedences_work_limit,omitempty"`
	...
	// relations.
	NoOverlap_2DBooleanRelationsLimit *int32 `protobuf:"varint,321,opt,name=no_overlap_2d_boolean_relations_limit,json=noOverlap2dBooleanRelationsLimit,def=10" json:"no_overlap_2d_boolean_relations_limit,omitempty"`
	...
	// part of the model.
	UseLinear3ForNoOverlap_2DPrecedences *bool `protobuf:"varint,323,opt,name=use_linear3_for_no_overlap_2d_precedences,json=useLinear3ForNoOverlap2dPrecedences,def=1" json:"use_linear3_for_no_overlap_2d_precedences,omitempty"`
	...
	RoutingCutSubsetSizeForExactBinaryRelationBound *int32 `protobuf:"varint,316,opt,name=routing_cut_subset_size_for_exact_binary_relation_bound,json=routingCutSubsetSizeForExactBinaryRelationBound,def=8" json:"routing_cut_subset_size_for_exact_binary_relation_bound,omitempty"`
	...
	RoutingCutSubsetSizeForShortestPathsBound *int32 `protobuf:"varint,318,opt,name=routing_cut_subset_size_for_shortest_paths_bound,json=routingCutSubsetSizeForShortestPathsBound,def=8" json:"routing_cut_subset_size_for_shortest_paths_bound,omitempty"`
	...
	// added to exclude it.
	RoutingCutMaxInfeasiblePathLength *int32                         `protobuf:"varint,317,opt,name=routing_cut_max_infeasible_path_length,json=routingCutMaxInfeasiblePathLength,def=6" json:"routing_cut_max_infeasible_path_length,omitempty"`
	...
	// disables it).
	ShavingDeterministicTimeInProbingSearch *float64 `protobuf:"fixed64,204,opt,name=shaving_deterministic_time_in_probing_search,json=shavingDeterministicTimeInProbingSearch,def=0.001" json:"shaving_deterministic_time_in_probing_search,omitempty"`
	// Specifies the amount of deterministic time spent of each try at shaving a
	// bound in the shaving search.
	ShavingSearchDeterministicTime *float64 `protobuf:"fixed64,205,opt,name=shaving_search_deterministic_time,json=shavingSearchDeterministicTime,def=0.1" json:"shaving_search_deterministic_time,omitempty"`
	...
	VariablesShavingLevel *int32 `protobuf:"varint,289,opt,name=variables_shaving_level,json=variablesShavingLevel,def=-1" json:"variables_shaving_level,omitempty"`
	...
	SharedTreeNumWorkers *int32 `protobuf:"varint,235,opt,name=shared_tree_num_workers,json=sharedTreeNumWorkers,def=-1" json:"shared_tree_num_workers,omitempty"`
	...
	SharedTreeSplitMinDtime *float64 `protobuf:"fixed64,328,opt,name=shared_tree_split_min_dtime,json=sharedTreeSplitMinDtime,def=0.1" json:"shared_tree_split_min_dtime,omitempty"`
	...
	// large.
	SolutionPoolDiversityLimit *int32 `protobuf:"varint,329,opt,name=solution_pool_diversity_limit,json=solutionPoolDiversityLimit,def=10" json:"solution_pool_diversity_limit,omitempty"`
	...
	AlternativePoolSize *int32 `protobuf:"varint,325,opt,name=alternative_pool_size,json=alternativePoolSize,def=1" json:"alternative_pool_size,omitempty"`
	...
	UseNewIntegerConflictResolution *bool `protobuf:"varint,336,opt,name=use_new_integer_conflict_resolution,json=useNewIntegerConflictResolution,def=0" json:"use_new_integer_conflict_resolution,omitempty"`
	...
	Create_1UipBooleanDuringIcr *bool `protobuf:"varint,341,opt,name=create_1uip_boolean_during_icr,json=create1uipBooleanDuringIcr,def=1" json:"create_1uip_boolean_during_icr,omitempty"`
...
const (
	...
	Default_SatParameters_BinaryMinimizationAlgorithm                     = SatParameters_BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS
	Default_SatParameters_SubsumptionDuringConflictAnalysis               = bool(true)
	Default_SatParameters_ExtraSubsumptionDuringConflictAnalysis          = bool(true)
	Default_SatParameters_DecisionSubsumptionDuringConflictAnalysis       = bool(true)
	Default_SatParameters_EagerlySubsumeLastNConflicts                    = int32(4)
	Default_SatParameters_SubsumeDuringVivification                       = bool(true)
	Default_SatParameters_UseChronologicalBacktracking                    = bool(false)
	Default_SatParameters_MaxBackjumpLevels                               = int32(50)
	Default_SatParameters_ChronologicalBacktrackMinConflicts              = int32(1000)
	Default_SatParameters_ClauseCleanupPeriod                             = int32(10000)
	Default_SatParameters_ClauseCleanupPeriodIncrement                    = int32(0)
	...
	Default_SatParameters_ClauseCleanupLbdTier1                           = int32(0)
	Default_SatParameters_ClauseCleanupLbdTier2                           = int32(0)
	...
	Default_SatParameters_FilterSatPostsolveClauses                       = bool(false)
	...
	Default_SatParameters_LoadAtMostOnesInSatPresolve                     = bool(false)
	...
	Default_SatParameters_MaxAlldiffDomainSize                            = int32(256)
	Default_SatParameters_ExpandReservoirConstraints                      = bool(true)
	Default_SatParameters_MaxDomainSizeForLinear2Expansion                = int32(8)
	...
	Default_SatParameters_FindClausesThatAreExactlyOne                    = bool(true)
	...
	Default_SatParameters_InprocessingUseCongruenceClosure                = bool(true)
	Default_SatParameters_InprocessingUseSatSweeping                      = bool(false)
	...
	Default_SatParameters_ShareLinear2Bounds                              = bool(false)
	Default_SatParameters_ShareBinaryClauses                              = bool(true)
	Default_SatParameters_ShareGlueClauses                                = bool(true)
	Default_SatParameters_MinimizeSharedClauses                           = bool(true)
	Default_SatParameters_ShareGlueClausesDtime                           = float64(1)
	Default_SatParameters_CheckLratProof                                  = bool(false)
	Default_SatParameters_CheckMergedLratProof                            = bool(false)
	Default_SatParameters_OutputLratProof                                 = bool(false)
	Default_SatParameters_CheckDratProof                                  = bool(false)
	Default_SatParameters_OutputDratProof                                 = bool(false)
	...
	Default_SatParameters_DebugCrashIfLratCheckFails                      = bool(false)
	...
	Default_SatParameters_TransitivePrecedencesWorkLimit                  = int32(1000000)
	...
	Default_SatParameters_NoOverlap_2DBooleanRelationsLimit               = int32(10)
	...
	Default_SatParameters_UseLinear3ForNoOverlap_2DPrecedences            = bool(true)
	...
	Default_SatParameters_RoutingCutSubsetSizeForExactBinaryRelationBound = int32(8)
	Default_SatParameters_RoutingCutSubsetSizeForShortestPathsBound       = int32(8)
	Default_SatParameters_RoutingCutDpEffort                              = float64(1e+07)
	Default_SatParameters_RoutingCutMaxInfeasiblePathLength               = int32(6)
	...
	Default_SatParameters_ShavingDeterministicTimeInProbingSearch         = float64(0.001)
	Default_SatParameters_ShavingSearchDeterministicTime                  = float64(0.1)
	...
	Default_SatParameters_VariablesShavingLevel                           = int32(-1)
	...
	Default_SatParameters_SharedTreeNumWorkers                            = int32(-1)
	...
	Default_SatParameters_SharedTreeSplitMinDtime                         = float64(0.1)
	...
	Default_SatParameters_SolutionPoolDiversityLimit                      = int32(10)
	Default_SatParameters_AlternativePoolSize                             = int32(1)
	...
	Default_SatParameters_UseNewIntegerConflictResolution                 = bool(false)
	Default_SatParameters_Create_1UipBooleanDuringIcr                     = bool(true)
...
var (
	...
	Default_SatParameters_MaxDratTimeInSeconds = float64(math.Inf(+1))
)
...
func (x *SatParameters) GetExtraSubsumptionDuringConflictAnalysis() bool {
	if x != nil && x.ExtraSubsumptionDuringConflictAnalysis != nil {
		return *x.ExtraSubsumptionDuringConflictAnalysis
	}
	return Default_SatParameters_ExtraSubsumptionDuringConflictAnalysis
}

func (x *SatParameters) GetDecisionSubsumptionDuringConflictAnalysis() bool {
	if x != nil && x.DecisionSubsumptionDuringConflictAnalysis != nil {
		return *x.DecisionSubsumptionDuringConflictAnalysis
	}
	return Default_SatParameters_DecisionSubsumptionDuringConflictAnalysis
}

func (x *SatParameters) GetEagerlySubsumeLastNConflicts() int32 {
	if x != nil && x.EagerlySubsumeLastNConflicts != nil {
		return *x.EagerlySubsumeLastNConflicts
	}
	return Default_SatParameters_EagerlySubsumeLastNConflicts
}

func (x *SatParameters) GetSubsumeDuringVivification() bool {
	if x != nil && x.SubsumeDuringVivification != nil {
		return *x.SubsumeDuringVivification
	}
	return Default_SatParameters_SubsumeDuringVivification
}

func (x *SatParameters) GetUseChronologicalBacktracking() bool {
	if x != nil && x.UseChronologicalBacktracking != nil {
		return *x.UseChronologicalBacktracking
	}
	return Default_SatParameters_UseChronologicalBacktracking
}

func (x *SatParameters) GetMaxBackjumpLevels() int32 {
	if x != nil && x.MaxBackjumpLevels != nil {
		return *x.MaxBackjumpLevels
	}
	return Default_SatParameters_MaxBackjumpLevels
}

func (x *SatParameters) GetChronologicalBacktrackMinConflicts() int32 {
	if x != nil && x.ChronologicalBacktrackMinConflicts != nil {
		return *x.ChronologicalBacktrackMinConflicts
	}
	return Default_SatParameters_ChronologicalBacktrackMinConflicts
}
...
func (x *SatParameters) GetClauseCleanupPeriodIncrement() int32 {
	if x != nil && x.ClauseCleanupPeriodIncrement != nil {
		return *x.ClauseCleanupPeriodIncrement
	}
	return Default_SatParameters_ClauseCleanupPeriodIncrement
}
...
func (x *SatParameters) GetClauseCleanupLbdTier1() int32 {
	if x != nil && x.ClauseCleanupLbdTier1 != nil {
		return *x.ClauseCleanupLbdTier1
	}
	return Default_SatParameters_ClauseCleanupLbdTier1
}

func (x *SatParameters) GetClauseCleanupLbdTier2() int32 {
	if x != nil && x.ClauseCleanupLbdTier2 != nil {
		return *x.ClauseCleanupLbdTier2
	}
	return Default_SatParameters_ClauseCleanupLbdTier2
}
...
func (x *SatParameters) GetFilterSatPostsolveClauses() bool {
	if x != nil && x.FilterSatPostsolveClauses != nil {
		return *x.FilterSatPostsolveClauses
	}
	return Default_SatParameters_FilterSatPostsolveClauses
}
...
func (x *SatParameters) GetLoadAtMostOnesInSatPresolve() bool {
	if x != nil && x.LoadAtMostOnesInSatPresolve != nil {
		return *x.LoadAtMostOnesInSatPresolve
	}
	return Default_SatParameters_LoadAtMostOnesInSatPresolve
}
...
func (x *SatParameters) GetMaxAlldiffDomainSize() int32 {
	if x != nil && x.MaxAlldiffDomainSize != nil {
		return *x.MaxAlldiffDomainSize
	}
	return Default_SatParameters_MaxAlldiffDomainSize
}
...
func (x *SatParameters) GetMaxDomainSizeForLinear2Expansion() int32 {
	if x != nil && x.MaxDomainSizeForLinear2Expansion != nil {
		return *x.MaxDomainSizeForLinear2Expansion
	}
	return Default_SatParameters_MaxDomainSizeForLinear2Expansion
}
...
func (x *SatParameters) GetFindClausesThatAreExactlyOne() bool {
	if x != nil && x.FindClausesThatAreExactlyOne != nil {
		return *x.FindClausesThatAreExactlyOne
	}
	return Default_SatParameters_FindClausesThatAreExactlyOne
}
...
func (x *SatParameters) GetInprocessingUseCongruenceClosure() bool {
	if x != nil && x.InprocessingUseCongruenceClosure != nil {
		return *x.InprocessingUseCongruenceClosure
	}
	return Default_SatParameters_InprocessingUseCongruenceClosure
}

func (x *SatParameters) GetInprocessingUseSatSweeping() bool {
	if x != nil && x.InprocessingUseSatSweeping != nil {
		return *x.InprocessingUseSatSweeping
	}
	return Default_SatParameters_InprocessingUseSatSweeping
}
...
func (x *SatParameters) GetShareLinear2Bounds() bool {
	if x != nil && x.ShareLinear2Bounds != nil {
		return *x.ShareLinear2Bounds
	}
	return Default_SatParameters_ShareLinear2Bounds
}
...
func (x *SatParameters) GetShareGlueClausesDtime() float64 {
	if x != nil && x.ShareGlueClausesDtime != nil {
		return *x.ShareGlueClausesDtime
	}
	return Default_SatParameters_ShareGlueClausesDtime
}

func (x *SatParameters) GetCheckLratProof() bool {
	if x != nil && x.CheckLratProof != nil {
		return *x.CheckLratProof
	}
	return Default_SatParameters_CheckLratProof
}

func (x *SatParameters) GetCheckMergedLratProof() bool {
	if x != nil && x.CheckMergedLratProof != nil {
		return *x.CheckMergedLratProof
	}
	return Default_SatParameters_CheckMergedLratProof
}

func (x *SatParameters) GetOutputLratProof() bool {
	if x != nil && x.OutputLratProof != nil {
		return *x.OutputLratProof
	}
	return Default_SatParameters_OutputLratProof
}

func (x *SatParameters) GetCheckDratProof() bool {
	if x != nil && x.CheckDratProof != nil {
		return *x.CheckDratProof
	}
	return Default_SatParameters_CheckDratProof
}

func (x *SatParameters) GetOutputDratProof() bool {
	if x != nil && x.OutputDratProof != nil {
		return *x.OutputDratProof
	}
	return Default_SatParameters_OutputDratProof
}

func (x *SatParameters) GetMaxDratTimeInSeconds() float64 {
	if x != nil && x.MaxDratTimeInSeconds != nil {
		return *x.MaxDratTimeInSeconds
	}
	return Default_SatParameters_MaxDratTimeInSeconds
}
...
func (x *SatParameters) GetDebugCrashIfLratCheckFails() bool {
	if x != nil && x.DebugCrashIfLratCheckFails != nil {
		return *x.DebugCrashIfLratCheckFails
	}
	return Default_SatParameters_DebugCrashIfLratCheckFails
}
...
func (x *SatParameters) GetTransitivePrecedencesWorkLimit() int32 {
	if x != nil && x.TransitivePrecedencesWorkLimit != nil {
		return *x.TransitivePrecedencesWorkLimit
	}
...
func (x *SatParameters) GetNoOverlap_2DBooleanRelationsLimit() int32 {
	if x != nil && x.NoOverlap_2DBooleanRelationsLimit != nil {
		return *x.NoOverlap_2DBooleanRelationsLimit
	}
	return Default_SatParameters_NoOverlap_2DBooleanRelationsLimit
}
...
func (x *SatParameters) GetUseLinear3ForNoOverlap_2DPrecedences() bool {
	if x != nil && x.UseLinear3ForNoOverlap_2DPrecedences != nil {
		return *x.UseLinear3ForNoOverlap_2DPrecedences
	}
	return Default_SatParameters_UseLinear3ForNoOverlap_2DPrecedences
}
...
func (x *SatParameters) GetRoutingCutSubsetSizeForExactBinaryRelationBound() int32 {
	if x != nil && x.RoutingCutSubsetSizeForExactBinaryRelationBound != nil {
		return *x.RoutingCutSubsetSizeForExactBinaryRelationBound
	}
	return Default_SatParameters_RoutingCutSubsetSizeForExactBinaryRelationBound
}

func (x *SatParameters) GetRoutingCutSubsetSizeForShortestPathsBound() int32 {
	if x != nil && x.RoutingCutSubsetSizeForShortestPathsBound != nil {
		return *x.RoutingCutSubsetSizeForShortestPathsBound
	}
	return Default_SatParameters_RoutingCutSubsetSizeForShortestPathsBound
}
...
func (x *SatParameters) GetRoutingCutMaxInfeasiblePathLength() int32 {
	if x != nil && x.RoutingCutMaxInfeasiblePathLength != nil {
		return *x.RoutingCutMaxInfeasiblePathLength
	}
	return Default_SatParameters_RoutingCutMaxInfeasiblePathLength
}
...
func (x *SatParameters) GetShavingDeterministicTimeInProbingSearch() float64 {
	if x != nil && x.ShavingDeterministicTimeInProbingSearch != nil {
		return *x.ShavingDeterministicTimeInProbingSearch
	}
	return Default_SatParameters_ShavingDeterministicTimeInProbingSearch
}
...
func (x *SatParameters) GetVariablesShavingLevel() int32 {
	if x != nil && x.VariablesShavingLevel != nil {
		return *x.VariablesShavingLevel
	}
	return Default_SatParameters_VariablesShavingLevel
}
...
func (x *SatParameters) GetSharedTreeSplitMinDtime() float64 {
	if x != nil && x.SharedTreeSplitMinDtime != nil {
		return *x.SharedTreeSplitMinDtime
	}
	return Default_SatParameters_SharedTreeSplitMinDtime
}
...
func (x *SatParameters) GetSolutionPoolDiversityLimit() int32 {
	if x != nil && x.SolutionPoolDiversityLimit != nil {
		return *x.SolutionPoolDiversityLimit
	}
	return Default_SatParameters_SolutionPoolDiversityLimit
}

func (x *SatParameters) GetAlternativePoolSize() int32 {
	if x != nil && x.AlternativePoolSize != nil {
		return *x.AlternativePoolSize
	}
	return Default_SatParameters_AlternativePoolSize
}
...
func (x *SatParameters) GetUseNewIntegerConflictResolution() bool {
	if x != nil && x.UseNewIntegerConflictResolution != nil {
		return *x.UseNewIntegerConflictResolution
	}
	return Default_SatParameters_UseNewIntegerConflictResolution
}

func (x *SatParameters) GetCreate_1UipBooleanDuringIcr() bool {
	if x != nil && x.Create_1UipBooleanDuringIcr != nil {
		return *x.Create_1UipBooleanDuringIcr
	}
	return Default_SatParameters_Create_1UipBooleanDuringIcr
}
...
const file_ortools_sat_sat_parameters_proto_rawDesc = "" +
	"\n" +
	" ortools/sat/sat_parameters.proto\x12\x17operations_research.sat\"\xbd\xb0\x01\n" +
	...
	"\x16minimization_algorithm\x18\x04 \x01(\x0e2D.operations_research.sat.SatParameters.ConflictMinimizationAlgorithm:\tRECURSIVER\x15minimizationAlgorithm\x12\xb0\x01\n" +
	"\x1dbinary_minimization_algorithm\x18\" \x01(\x0e2@.operations_research.sat.SatParameters.BinaryMinizationAlgorithm:*BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONSR\x1bbinaryMinimizationAlgorithm\x12U\n" +
	"$subsumption_during_conflict_analysis\x188 \x01(\b:\x04trueR!subsumptionDuringConflictAnalysis\x12a\n" +
	"*extra_subsumption_during_conflict_analysis\x18\xdf\x02 \x01(\b:\x04trueR&extraSubsumptionDuringConflictAnalysis\x12g\n" +
	"-decision_subsumption_during_conflict_analysis\x18\xe1\x02 \x01(\b:\x04trueR)decisionSubsumptionDuringConflictAnalysis\x12J\n" +
	" eagerly_subsume_last_n_conflicts\x18\xd7\x02 \x01(\x05:\x014R\x1ceagerlySubsumeLastNConflicts\x12E\n" +
	"\x1bsubsume_during_vivification\x18\xe3\x02 \x01(\b:\x04trueR\x19subsumeDuringVivification\x12L\n" +
	"\x1euse_chronological_backtracking\x18\xca\x02 \x01(\b:\x05falseR\x1cuseChronologicalBacktracking\x123\n" +
	"\x13max_backjump_levels\x18\xcb\x02 \x01(\x05:\x0250R\x11maxBackjumpLevels\x12X\n" +
	"%chronological_backtrack_min_conflicts\x18\xcc\x02 \x01(\x05:\x041000R\"chronologicalBacktrackMinConflicts\x129\n" +
	"\x15clause_cleanup_period\x18\v \x01(\x05:\x0510000R\x13clauseCleanupPeriod\x12I\n" +
	"\x1fclause_cleanup_period_increment\x18\xd1\x02 \x01(\x05:\x010R\x1cclauseCleanupPeriodIncrement\x125\n" +
	"\x15clause_cleanup_target\x18\r \x01(\x05:\x010R\x13clauseCleanupTarget\x126\n" +
	"\x14clause_cleanup_ratio\x18\xbe\x01 \x01(\x01:\x030.5R\x12clauseCleanupRatio\x12:\n" +
	"\x18clause_cleanup_lbd_bound\x18; \x01(\x05:\x015R\x15clauseCleanupLbdBound\x12;\n" +
	"\x18clause_cleanup_lbd_tier1\x18\xdd\x02 \x01(\x05:\x010R\x15clauseCleanupLbdTier1\x12;\n" +
	"\x18clause_cleanup_lbd_tier2\x18\xde\x02 \x01(\x05:\x010R\x15clauseCleanupLbdTier2\x12~\n" +
	...
	"\x16presolve_bve_threshold\x186 \x01(\x05:\x03500R\x14presolveBveThreshold\x12G\n" +
	"\x1cfilter_sat_postsolve_clauses\x18\xc4\x02 \x01(\b:\x05falseR\x19filterSatPostsolveClauses\x12>\n" +
	...
	"\x19cp_model_use_sat_presolve\x18] \x01(\b:\x04trueR\x15cpModelUseSatPresolve\x12N\n" +
	"!load_at_most_ones_in_sat_presolve\x18\xcf\x02 \x01(\b:\x05falseR\x1bloadAtMostOnesInSatPresolve\x12F\n" +
	...
	"\x1aexpand_alldiff_constraints\x18\xaa\x01 \x01(\b:\x05falseR\x18expandAlldiffConstraints\x12;\n" +
	"\x17max_alldiff_domain_size\x18\xc0\x02 \x01(\x05:\x03256R\x14maxAlldiffDomainSize\x12G\n" +
	"\x1cexpand_reservoir_constraints\x18\xb6\x01 \x01(\b:\x04trueR\x1aexpandReservoirConstraints\x12S\n" +
	"%max_domain_size_for_linear2_expansion\x18\xd4\x02 \x01(\x05:\x018R maxDomainSizeForLinear2Expansion\x12K\n" +
	...
	"\x17find_big_linear_overlap\x18\xea\x01 \x01(\b:\x04trueR\x14findBigLinearOverlap\x12N\n" +
	"!find_clauses_that_are_exactly_one\x18\xcd\x02 \x01(\b:\x04trueR\x1cfindClausesThatAreExactlyOne\x127\n" +
	...
	"+inprocessing_minimization_use_all_orderings\x18\xaa\x02 \x01(\b:\x05falseR'inprocessingMinimizationUseAllOrderings\x12T\n" +
	"#inprocessing_use_congruence_closure\x18\xd6\x02 \x01(\b:\x04trueR inprocessingUseCongruenceClosure\x12I\n" +
	"\x1dinprocessing_use_sat_sweeping\x18\xe2\x02 \x01(\b:\x05falseR\x1ainprocessingUseSatSweeping\x12#\n" +
	...
	"\x17share_level_zero_bounds\x18r \x01(\b:\x04trueR\x14shareLevelZeroBounds\x128\n" +
	"\x14share_linear2_bounds\x18\xc6\x02 \x01(\b:\x05falseR\x12shareLinear2Bounds\x127\n" +
	"\x14share_binary_clauses\x18\xcb\x01 \x01(\b:\x04trueR\x12shareBinaryClauses\x123\n" +
	"\x12share_glue_clauses\x18\x9d\x02 \x01(\b:\x04trueR\x10shareGlueClauses\x12=\n" +
	"\x17minimize_shared_clauses\x18\xac\x02 \x01(\b:\x04trueR\x15minimizeSharedClauses\x12;\n" +
	"\x18share_glue_clauses_dtime\x18\xc2\x02 \x01(\x01:\x011R\x15shareGlueClausesDtime\x120\n" +
	"\x10check_lrat_proof\x18\xd8\x02 \x01(\b:\x05falseR\x0echeckLratProof\x12=\n" +
	"\x17check_merged_lrat_proof\x18\xe0\x02 \x01(\b:\x05falseR\x14checkMergedLratProof\x122\n" +
	"\x11output_lrat_proof\x18\xd9\x02 \x01(\b:\x05falseR\x0foutputLratProof\x120\n" +
	"\x10check_drat_proof\x18\xda\x02 \x01(\b:\x05falseR\x0echeckDratProof\x122\n" +
	"\x11output_drat_proof\x18\xdb\x02 \x01(\b:\x05falseR\x0foutputDratProof\x12<\n" +
	"\x18max_drat_time_in_seconds\x18\xdc\x02 \x01(\x01:\x03infR\x14maxDratTimeInSeconds\x12N\n" +
	...
	"#debug_crash_if_presolve_breaks_hint\x18\xb2\x02 \x01(\b:\x05falseR\x1edebugCrashIfPresolveBreaksHint\x12K\n" +
	"\x1fdebug_crash_if_lrat_check_fails\x18\xd3\x02 \x01(\b:\x05falseR\x1adebugCrashIfLratCheckFails\x12:\n" +
	...
	")use_precedences_in_disjunctive_constraint\x18J \x01(\b:\x04trueR%usePrecedencesInDisjunctiveConstraint\x12S\n" +
	"!transitive_precedences_work_limit\x18\xc7\x02 \x01(\x05:\a1000000R\x1etransitivePrecedencesWorkLimit\x12r\n" +
	...
	"7routing_cut_subset_size_for_tight_binary_relation_bound\x18\xb9\x02 \x01(\x05:\x010R/routingCutSubsetSizeForTightBinaryRelationBound\x12t\n" +
	"7routing_cut_subset_size_for_exact_binary_relation_bound\x18\xbc\x02 \x01(\x05:\x018R/routingCutSubsetSizeForExactBinaryRelationBound\x12g\n" +
	"0routing_cut_subset_size_for_shortest_paths_bound\x18\xbe\x02 \x01(\x05:\x018R)routingCutSubsetSizeForShortestPathsBound\x12<\n" +
	"\x15routing_cut_dp_effort\x18\xba\x02 \x01(\x01:\b10000000R\x12routingCutDpEffort\x12U\n" +
	"&routing_cut_max_infeasible_path_length\x18\xbd\x02 \x01(\x05:\x016R!routingCutMaxInfeasiblePathLength\x12s\n" +
	...
	"\x1eprobing_num_combinations_limit\x18\x90\x02 \x01(\x05:\x0520000R\x1bprobingNumCombinationsLimit\x12e\n" +
	",shaving_deterministic_time_in_probing_search\x18\xcc\x01 \x01(\x01:\x050.001R'shavingDeterministicTimeInProbingSearch\x12O\n" +
	"!shaving_search_deterministic_time\x18\xcd\x01 \x01(\x01:\x030.1R\x1eshavingSearchDeterministicTime\x12=\n" +
	...
	"\x1cuse_objective_shaving_search\x18\xfd\x01 \x01(\b:\x05falseR\x19useObjectiveShavingSearch\x12;\n" +
	"\x17variables_shaving_level\x18\xa1\x02 \x01(\x05:\x02-1R\x15variablesShavingLevel\x12N\n" +
	...
	"&violation_ls_compound_move_probability\x18\x83\x02 \x01(\x01:\x030.5R\"violationLsCompoundMoveProbability\x12:\n" +
	"\x17shared_tree_num_workers\x18\xeb\x01 \x01(\x05:\x02-1R\x14sharedTreeNumWorkers\x12;\n" +
	...
	"\x1dshared_tree_balance_tolerance\x18\xb1\x02 \x01(\x05:\x011R\x1asharedTreeBalanceTolerance\x12B\n" +
	"\x1bshared_tree_split_min_dtime\x18\xc8\x02 \x01(\x01:\x030.1R\x17sharedTreeSplitMinDtime\x12=\n" +
	...
	"useLnsOnly\x120\n" +
	"\x12solution_pool_size\x18\xc1\x01 \x01(\x05:\x013R\x10solutionPoolSize\x12F\n" +
	"\x1dsolution_pool_diversity_limit\x18\xc9\x02 \x01(\x05:\x0210R\x1asolutionPoolDiversityLimit\x126\n" +
	"\x15alternative_pool_size\x18\xc5\x02 \x01(\x05:\x011R\x13alternativePoolSize\x12'\n" +
	...
	"\x14PROPAGATION_ASSISTED\x10\x02Bh\n" +
	"\x16com.google.ortools.satP\x01Z7github.com/airspacetechnologies/or-tools/go/ortools/sat\xaa\x02\x12Google.OrTools.Sat"
...
var file_ortools_sat_sat_parameters_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
...
var file_ortools_sat_sat_parameters_proto_goTypes = []any{
	...
	(SatParameters_ClauseOrdering)(0),                // 4: operations_research.sat.SatParameters.ClauseOrdering
	(SatParameters_RestartAlgorithm)(0),              // 5: operations_research.sat.SatParameters.RestartAlgorithm
	(SatParameters_MaxSatAssumptionOrder)(0),         // 6: operations_research.sat.SatParameters.MaxSatAssumptionOrder
	(SatParameters_MaxSatStratificationAlgorithm)(0), // 7: operations_research.sat.SatParameters.MaxSatStratificationAlgorithm
	(SatParameters_SearchBranching)(0),               // 8: operations_research.sat.SatParameters.SearchBranching
	(SatParameters_SharedTreeSplitStrategy)(0),       // 9: operations_research.sat.SatParameters.SharedTreeSplitStrategy
...
var file_ortools_sat_sat_parameters_proto_depIdxs = []int32{
	...
	4,  // 4: operations_research.sat.SatParameters.clause_cleanup_ordering:type_name -> operations_research.sat.SatParameters.ClauseOrdering
	5,  // 5: operations_research.sat.SatParameters.restart_algorithms:type_name -> operations_research.sat.SatParameters.RestartAlgorithm
	11, // 6: operations_research.sat.SatParameters.subsolver_params:type_name -> operations_research.sat.SatParameters
	6,  // 7: operations_research.sat.SatParameters.max_sat_assumption_order:type_name -> operations_research.sat.SatParameters.MaxSatAssumptionOrder
	...
	8,  // 9: operations_research.sat.SatParameters.search_branching:type_name -> operations_research.sat.SatParameters.SearchBranching
	9,  // 10: operations_research.sat.SatParameters.shared_tree_split_strategy:type_name -> operations_research.sat.SatParameters.SharedTreeSplitStrategy
	10, // 11: operations_research.sat.SatParameters.fp_rounding:type_name -> operations_research.sat.SatParameters.FPRoundingMethod
